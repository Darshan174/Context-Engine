...
import {
  CheckCircle2, History, ShieldAlert, Cpu, ArrowRight,
  BookOpen, AlertCircle, Database, Zap, GitBranch, MessageSquare,
  Network, PlugZap, BrainCircuit, Clock
} from "lucide-react";
...
const HOW_IT_WORKS = [
  {
    ...
    body: "Sync Slack, GitHub, Zoom, Gmail, and more. Context Engine ingests raw messages, decisions, and discussions in real time.",
    icon: PlugZap,
...
const CAPABILITIES = [
  {
    ...
    body: "Auto-summarize what changed, what is risky, and resolve flagged conflicts in the Review Queue.",
  },
  {
    icon: CheckCircle2,
    title: "Decision Register",
    body: "Track current and historical decisions — their rationale, blockers, and original source evidence.",
  },
  {
    icon: History,
    title: "What Changed Timeline",
    body: "Rewind your team's brain. View a clear timeline of decision changes, tool ingests, and knowledge drift.",
  },
  {
    icon: ShieldAlert,
    title: "Launch Guard",
...
function Logos() {
  return (
    <>
      ...
      <LogoItem name="Notion"><path d="M4.1 3.511a1.27 1.27 0 0 1 1.282-1.2h12.5a1.27 1.27 0 0 1 1.283 1.2l.006 17a1.27 1.27 0 0 1-1.281 1.21h-12.5a1.28 1.28 0 0 1-1.283-1.196zm2.4 2.87v10.15l7.98-10.15h1.99V17h-1.84V7.53L7.33 17.02H5.34v-10.64h1.16z" /></LogoItem>
      ...
      <LogoItem name="Jira"><path d="M11.53 17.53A4.53 4.53 0 0 1 7 13V2.47a.47.47 0 0 0-.47-.47H2.47A.47.47 0 0 0 2 2.47V13a9.06 9.06 0 0 0 9.06 9.06h8.47a.47.47 0 0 0 .47-.47v-4.06a.47.47 0 0 0-.47-.47h-8.06zM21.53 9.47A9.06 9.06 0 0 0 12.47.41h-2A.47.47 0 0 0 10 .88v4.06A.47.47 0 0 0 10.47 5.4h2A4.53 4.53 0 0 1 17 9.94v8.06a.47.47 0 0 0 .47.47h4.06a.47.47 0 0 0 .47-.47V9.47z"/></LogoItem>
